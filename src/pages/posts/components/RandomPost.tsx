				...
				<div className='md:ml-4 lg:ml-6 xl:ml-10 w-full md:w-1/2'>
					...
					<div className='flex flex-row items-center'>
						<Link to={`/@${postData[0]?.user.username}`} className="relative group">
							<img src={postData[0]?.user.avatar_url ? getAvatarUrl(postData[0]?.user.avatar_url) : '/specwiselogo.png'} alt="" className="w-8 h-8 sm:w-10 sm:h-10 md:w-10 md:h-10 rounded-full mr-3 sm:mr-4 object-cover" />
